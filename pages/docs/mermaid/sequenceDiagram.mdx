...
This can be configured by adding one or more link lines with the format:
    ...
    link <actor>: <link-label> @ <link-url> </link-url> </link-label> </actor>
...
| messageFontSize   | Sets the font size for actor to actor messages                                                                                              | 16                             |
| messageFontFamily | Sets the font family for actor to actor messages                                                                                            | "trebuchet ms", verdana, arial |
| messageFontWeight | Sets the font weight for actor to actor messages                                                                                            | "trebuchet ms", verdana, arial |
