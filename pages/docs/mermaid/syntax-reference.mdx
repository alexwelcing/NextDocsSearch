...
The [Getting Started](getting-started.mdx) section can also provide some practical examples of mermaid syntax.
...
The following are the most commonly used methods, and they are all tied to Mermaid [Deployment](getting-started.mdx) methods.

### Configuration Section in the [Live Editor](https://mermaid.live).

Here you can edit certain values to change the behavior and appearance of the diagram.

### [The initialize() call](getting-started.mdx#_3-calling-the-javascript-api)
