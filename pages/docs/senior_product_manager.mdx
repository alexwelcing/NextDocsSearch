...
Alex Welcing has specific experience building products using React Native, Microsoft Azure, TypeScript, and more. He provides technical empathetic leadership for startups, enterprises, and teams seeking to grow sustainably.