...
date: '2047-03-15'
description: >-
  Two groups of cognitive cartographers map the same region of the boundary
  and produce radically different maps. One sees landscape — static,
  discoverable. The other sees weather — dynamic, participatory. The dispute
  paralyzes the field for three years. Its resolution — that both maps are
  correct at different timescales — becomes the first principle of cognitive
  cartography.
keywords:
  - territorial dispute
...
ogImage: /images/og/echo-chamber-01-the-territorial-dispute.svg
---
