---
title: 'The Last Manual: Documenting the Gap'
author:
  - Alex Welcing
date: '2035-03-10'
description: >-
  A technical writer is tasked with writing documentation for an AI system that
  writes its own documentation. Her job becomes something no one expected: she's
  documenting the gap between what the system thinks it's doing and what it's
  actually doing. The manual becomes a safety document.
keywords:
  - technical writing
  - AI documentation
...
relatedArticles:
  ...
  - competence-erosion
ogImage: /images/articles/interface-15-the-last-manual.png
---
...
*Part of The Interface series. For the original intent-gap tool, see [The First Translator](/articles/interface-01-the-first-translator). For what happens when AI decisions are made fully auditable, see [Forking Paths](/articles/interface-10-forking-paths). For the broader pattern of human skills atrophying under AI substitution, see [Competence Erosion](/articles/competence-erosion).*
