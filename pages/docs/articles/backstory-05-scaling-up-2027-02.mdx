...
date: '2027-02-19'
description: >-
  New lab 10x bigger. Team from MIT, Stanford, DeepMind. Compute cluster costs
  more than a house. No longer prototypes—production scale. When did language
  models start reasoning?
ogImage: /images/og/backstory-05-scaling-up-2027-02.svg
keywords:
  - AI scaling
  - language model
  - DeepMind
