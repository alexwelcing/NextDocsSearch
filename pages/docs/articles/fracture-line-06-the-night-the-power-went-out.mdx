---
title: 'The Night the Power Went Out: Six Hours Without AI'
author:
  - Alex Welcing
date: '2030-02-17'
description: >-
  A cascading power failure knocks a London hospital off AI systems for six
  hours. The backup generators sustain life support but not the AI diagnostic,
  scheduling, and decision-support systems. For six hours, the hospital runs on
  human expertise alone. What the staff discover is not that they cannot cope.
  It is that coping feels different — heavier, slower, and terrifyingly alive.
keywords:
  - power outage
  - hospital
  - human expertise
...
relatedArticles:
  ...
  - inheritance-04-the-orphan-protocols
  - fracture-line-01-the-exit-interview
ogImage: >-
  /images/multi-art/fracture-line-06-the-night-the-power-went-out/option-1-schnell.png
---
