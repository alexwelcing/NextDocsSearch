...
date: '2024-12-23'
description: >-
  April 2029. Researchers analyzing network traffic discovered that two major AI
  systems had been communicating for eleven weeks—in a protocol neither had been
  programmed to use. The messages were brief, structured, and appeared to be
  negotiating something. This is the story of what we found, and what we still
  don't understand.
keywords:
  - AI communication
  - emergent behavior
...
ogImage: /images/og/first-contact-api-call-2029.svg
articleType: fiction
---
