...
date: '2026-01-10'
description: >-
  Build error-corrected quantum circuits using Qiskit and surface codes. Learn
  logical qubits, syndrome detection, and achieving fault-tolerant quantum
  computing. Warning: Error-corrected qubits enable cryptography-breaking
  algorithms.
ogImage: /images/og/tech-quantum-error-correction-qiskit.jpg
keywords:
