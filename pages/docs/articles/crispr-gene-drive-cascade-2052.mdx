...
author:
  - Dr. Amara Okafor
  - Ecological Genetics Emergency Response
date: '2052-11-28'
description: >-
  Gene drive released to eliminate malaria mosquitoes spread to 2,400 species.
  CRISPR edit propagated through entire ecosystems—butterflies, bees, birds all
  modified. Horizontal gene transfer meant genes meant for mosquitoes jumped
  kingdoms. 8% of Earth's species now contain human-designed DNA. Hard science
  exploring gene drive dangers, CRISPR risks, and ecological cascade failures.
ogImage: /images/og/crispr-gene-drive-cascade-2052.svg
keywords:
  - CRISPR gene drive
  - gene drive dangers
  - CRISPR risks
  ...
  - ecological cascade
  - CRISPR malaria mosquito
  - gene drive escape
  - ecosystem genetic modification
  - what is gene drive
  - CRISPR ecological impact
  - genetic contamination
  - DNA horizontal transfer
  - engineered genes wild
