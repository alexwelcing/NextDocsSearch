...
<ArticleCreationEmbed
  prompt="A massive industrial robotic arm twisted into impossible angles, assembly lines forming recursive loops, sparks and molten metal forming fractal patterns, machinery that builds more of itself"
  autoRotate={true}
  height={500}
/>
