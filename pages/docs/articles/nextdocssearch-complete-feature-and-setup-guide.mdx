...
![The 3D scene rendered with React Three Fiber, featuring interactive objects, dynamic lighting, and particle effects](/images/screenshots/nextdocssearch/01-3d-scene.svg)
...
![Camera choreography path showing the intro, transition, and interactive phases](/images/screenshots/nextdocssearch/02-cinematic-intro.svg)
...
![Side-by-side comparison of image sphere and Gaussian splat background modes](/images/screenshots/nextdocssearch/03-dynamic-backgrounds.svg)
...
![Seasonal effects including winter snow, spring petals, summer fireflies, and autumn leaves](/images/screenshots/nextdocssearch/04-seasonal-effects.svg)
...
![The 3D tablet opens a terminal overlay for AI chat, articles, quizzes, and leaderboard](/images/screenshots/nextdocssearch/05-interactive-tablet.svg)
...
![Semantic search using OpenAI embeddings and Supabase pgvector for concept-level article discovery](/images/screenshots/nextdocssearch/06-ai-search.svg)
...
![The MDX publishing pipeline from writing to build scripts to generated data to deployment](/images/screenshots/nextdocssearch/07-mdx-pipeline.svg)
...
![Sphere Hunter game with HUD showing score, timer, combo multiplier, and game state flow](/images/screenshots/nextdocssearch/08-sphere-hunter.svg)
...
![Quest progress tracking and achievement badges with localStorage persistence](/images/screenshots/nextdocssearch/09-journey-system.svg)
...
![Supabase data layer with PostgreSQL, pgvector, storage, and migrations](/images/screenshots/nextdocssearch/10-supabase-backend.svg)
