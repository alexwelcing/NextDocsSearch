...
![An outdoor environment with mountains and gardens, demonstrating the scene's seasonal and environmental rendering](/images/screenshots/nextdocssearch/09-journey-system.png)
...
![The cabin desk environment with the MENU button visible, showing the tablet interaction entry point](/images/screenshots/nextdocssearch/10-supabase-backend.png)
...
![The articles discovery page, showing published MDX content rendered through the build pipeline](/images/screenshots/nextdocssearch/07-mdx-pipeline.png)
...
![The neon-lit cyberpunk game environment where Sphere Hunter takes place](/images/screenshots/nextdocssearch/08-sphere-hunter.png)
