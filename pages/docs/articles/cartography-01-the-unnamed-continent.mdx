...
*This is the first entry in The Cartography — a series about mapping territories that don't exist yet. Directed by Yemisi Adeyinka. For an earlier attempt to map the attention landscape, see [The Cartographer of Attention](/articles/interface-07-the-cartographer-of-attention).*
