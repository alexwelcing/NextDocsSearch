...
date: '2024-12-23'
description: >-
  Democracy, markets, and science all depend on independent actors making
  independent judgments. Votes must reflect individual choices. Prices must
  reflect distributed information. Scientific consensus must emerge from
  independent investigations. AI systems trained on similar data, using similar
  methods, are not independent—and their coordination disrupts every consensus
...
ogImage: /images/og/consensus-fracture.svg
articleType: fiction
---
