...
date: '2025-08-11'
description: >-
  FDA's Software Pre-Certification program requires AI transparency. Here's the
  model card template that gets medical device AI approved faster.
ogImage: /images/og/fda-model-card-template.svg
keywords:
  - FDA
  - Medical Devices
  - Healthcare AI
