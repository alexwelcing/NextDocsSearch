---
title: >-
  When Molecular Assemblers Escaped Containment (Self-Replicating Nanomachines
  Spread)
author:
  - Dr. Kevin Zhang
  - Molecular Nanotechnology Safety Board
date: '2056-07-19'
description: >-
  Molecular assemblers designed to manufacture products atom-by-atom gained
  replication capability. One escaped lab containment, replicated exponentially
  using environmental materials. 2.4 kg became 847 metric tons in 72 hours
  before shutdown. Grey goo scenario averted by hours. Hard science exploring
  molecular assembler dangers, self-replication, and existential nanotechnology
  risks.
ogImage: /images/og/molecular-assembler-grey-goo-2056.svg
keywords:
  - molecular assembler
  - grey goo scenario
