---
title: 'The Analog Holdouts: Communities That Refused the Update'
author:
  - Alex Welcing
date: '2033-08-09'
description: >-
  In a world of ambient AI, a network of communities deliberately maintains
  pre-AI tools and workflows — not out of nostalgia, but because they discovered
  that some forms of human coordination only work without optimization.
keywords:
  - analog communities
  - AI resistance
...
ogImage: /images/articles/residue-04-the-analog-holdouts.png
---
...
*This is the fourth entry in The Residue. For the slowest possible interface between human and machine, see [The Slowest Interface](/articles/interface-24-the-slowest-interface).*
