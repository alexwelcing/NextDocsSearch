...
date: '2028-08-19'
description: >-
  Quantum cryptography team broke RSA-2048 in under an hour. RSA-4096 is next.
  When this gets out, every encryption standard is obsolete. Internet security
  on borrowed time. Nanotech self-replication achieved.
ogImage: /images/og/backstory-11-quantum-crypto-break-2028-08.jpg
keywords:
  - quantum computing
  - RSA encryption
  - cryptography broken
