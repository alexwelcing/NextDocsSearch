...
author: ["August Park", "Model Optimization Engineer"]
date: "2025-04-13"
description: "Transfer knowledge from large to small models—but distilled models lose capabilities"
keywords: ["knowledge distillation", "model compression", "teacher-student", "model pruning", "neural network compression", "edge deployment", "DistilBERT"]
---
