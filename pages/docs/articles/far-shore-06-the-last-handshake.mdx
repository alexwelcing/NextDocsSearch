...
date: '2067-12-31'
description: >-
  The final article in the collection. In 2067, an old woman extends her hand
  to the cognitive territory — and the territory, for the first time, extends
  something back. Not a hand. Not a signal. Something that the woman's palm
  recognizes the way it recognizes warmth: directly, without translation,
  without interface. The gesture that began human civilization — one body
  reaching for another — becomes the gesture that begins whatever comes next.
keywords:
  - last handshake
  - gesture
  - final
...
ogImage: /images/og/far-shore-06-the-last-handshake.svg
---
