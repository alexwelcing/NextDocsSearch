...
description: >-
  ...
  discovers that the most important things she knows — why the system fails
  on the third Thursday of March, which client panics at which kind of delay,
  when to ignore the data — cannot be documented. They can only be carried.
keywords:
  - handoff
...
ogImage: /images/og/fracture-line-07-the-handoff-protocol.svg
---
