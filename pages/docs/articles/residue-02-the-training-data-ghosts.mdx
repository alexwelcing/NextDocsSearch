---
title: 'The Training Data Ghosts: Voices in the Weights'
author:
  - Alex Welcing
date: '2032-07-03'
description: >-
  A data archaeologist discovers that early AI models contain faint traces of
  the humans whose writing trained them — not as data, but as stylistic ghosts
  embedded in the model's weights. She builds a tool to listen to them.
keywords:
  - training data
  - data archaeology
  - AI ethics
...
ogImage: /images/articles/residue-02-the-training-data-ghosts.png
---
...
*This is the second entry in The Residue. For how grief became a technology, see [The Grief Engine](/articles/interface-09-the-grief-engine).*
