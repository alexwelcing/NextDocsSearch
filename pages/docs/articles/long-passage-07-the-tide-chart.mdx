...
description: >-
  ...
  no one has mapped. She applies tidal models to the boundary data and
  discovers daily, seasonal, and one very long cycle that corresponds to no
  known natural rhythm. She suspects it has something to do with dreaming.
keywords:
  - tide chart
  - marine biology
  - rhythms
...
ogImage: /images/og/long-passage-07-the-tide-chart.svg
---
