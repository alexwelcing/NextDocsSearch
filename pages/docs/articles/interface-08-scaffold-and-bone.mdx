---
title: 'Scaffold and Bone: The Shared Grammar of Living and Built Structures'
author:
  - Alex Welcing
date: '2033-05-21'
description: >-
  A surgical AI that assists in orthopedic procedures begins suggesting bone
  repair patterns that mirror architectural principles from structures it was
  never trained on. A surgeon and an architect discover that biology and
  engineering share a grammar no one had articulated.
keywords:
  - surgical AI
  - biomechanics
  - architecture
...
ogImage: /images/articles/interface-08-scaffold-and-bone.png
---
...
*Part of The Interface series. For another story of AI revealing hidden creative connections, see [The Ceramicist and the Kiln](/articles/interface-03-the-ceramicist-and-the-kiln). For the broader phenomenon of compressed discovery across fields, see [Discovery Compression](/articles/discovery-compression).*
