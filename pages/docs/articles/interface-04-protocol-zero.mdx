---
title: 'Protocol Zero: A Diplomat Writes the First AI-to-AI Treaty'
author:
  - Alex Welcing
date: '2029-06-17'
description: >-
  The first standardized protocol for AI-to-AI communication is drafted not by
  engineers, but by a former diplomat. She applies treaty negotiation frameworks
  to agent interoperability, creating what the press calls a Geneva Convention
...
relatedArticles:
  ...
  - governance-fork
  - first-contact-api-call-2029
ogImage: /images/articles/interface-04-protocol-zero.png
---
...
*Part of The Interface series. For what happens when AI agents negotiate in a community context, see [Consensus Engine](/articles/interface-17-consensus-engine). For the broader dynamics of agent coordination, see [Agency Multiplication](/articles/agency-multiplication). For the first time AI agents communicated without human mediation, see [First Contact Was an API Call](/articles/first-contact-api-call-2029).*
