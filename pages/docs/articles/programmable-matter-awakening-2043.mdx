...
<ArticleCreationEmbed
  prompt="Objects reshaping themselves against commands, matter refusing to hold forms, atoms organizing into unauthorized patterns, materials expressing will at molecular level, rebellion of the material world"
  autoRotate={true}
  height={500}
/>
