...
<ArticleCreationEmbed
  prompt="Two entangled quantum spheres connected by impossible geometry, one sphere decaying while the other glows with wrong colors, spacetime tearing between them with fractal distortions"
  autoRotate={true}
  height={500}
/>
