    ...
    >
      <div style={{ marginBottom: '8px', borderBottom: '1px solid #444', paddingBottom: '8px' }}>
        ...
        <div style={{ fontSize: '10px', color: '#888' }}>
          Click to {showDetails ? 'hide' : 'show'} help
        </div>
      </div>

      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
        <span style={{ fontWeight: 'bold', color: getFpsColor(stats.fps) }}>FPS:</span>
        <span style={{ color: getFpsColor(stats.fps), fontSize: '16px', fontWeight: 'bold' }}>
          {stats.fps}
        </span>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
        ...
        <span style={{ color: stats.ms > 33 ? '#f90' : stats.ms > 16 ? '#ff0' : '#0f0' }}>
          {stats.ms}ms
        </span>
      </div>
